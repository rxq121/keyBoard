package com.example.administrator.keyboard.weight;
...
public class SearchResultLinearLayoutManager extends LinearLayoutManager {
    ...
    public SearchResultLinearLayoutManager(Context context, int orientation, boolean reverseLayout,
                                           int maxVisibleItem) {
        super(context, orientation, reverseLayout);
        init(context, maxVisibleItem);
    }

    public SearchResultLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr,
                                           int defStyleRes, int maxVisibleItem) {
